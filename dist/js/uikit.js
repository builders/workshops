    ...
    var Sticky = {
        ...
        update: [{
            ...
            write: function write(ref) {
                ...
                css(placeholder, assign({ height: css(this.$el, 'position') !== 'absolute' ? height$$1 : '' }, css(this.$el, ['marginTop', 'marginBottom', 'marginLeft', 'marginRight'])));
    ...
    function Transitioner$1(prev, next, dir, ref) {
        ...
        return {
            ...
            translate: function translate(percent) {
                ...
                css(list, 'transform', _translate(clamp(-to + (distance - distance * percent), -getWidth(list), list.offsetWidth) * (isRtl ? -1 : 1), 'px'));
